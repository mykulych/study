...
export default function AuthNewPasswordForm() {
  ...
  const VerifyCodeSchema = Yup.object().shape({
    ...
    email: Yup.string().required('Email is required').email('Email має бути валідним'),
    password: Yup.string()
      .min(6, 'Пароль має містити принаймні 6 символів')
      .required('Пароль є необхідний'),
    confirmPassword: Yup.string()
      .required('Підтвердження паролю є необхідним')
      .oneOf([Yup.ref('password')], 'Паролі має бути однакові'),
  });
