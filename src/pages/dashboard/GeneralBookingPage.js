...
const TABLE_HEAD = [
  { id: 'name', label: "Ім'я", align: 'left' },
  { id: 'company', label: 'Пошта', align: 'left' },
  { id: 'role', label: 'Група', align: 'left' },
  { id: 'isVerified', label: 'Кількість спроб', align: 'center' },
  { id: 'status', label: 'Середній бал', align: 'left' },
  { id: '' },
];
...
export default function UserListPage() {
  const _userList=getUserDataFromLocalStorage();
...
function applyFilter({ inputData, comparator, filterName, filterStatus, filterRole }) {
  ...
  if (filterRole !== 'all') {
    inputData = inputData.filter((user) => user.group === filterRole);
  }
