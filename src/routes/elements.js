...
export const ChatInfo = Loadable(
  lazy(() => import('../pages/dashboard/ChatInfo'))
);
...
export const BlogPostsPageTest2 = Loadable(lazy(() => import('../pages/dashboard/BlogPostsPageTest2')));
export const BlogPostsPageTest3 = Loadable(lazy(() => import('../pages/dashboard/BlogPostsPageTest3')));
